...
struct OrderHistoryPage: View {
    ...
    var body: some View {
                ...
                HStack(spacing: 8) {
                    ForEach(0..<filterLabels.count, id: \.self) { idx in
                        Button {
                            ...
                            Text(filterLabels[idx].localized)
        ...
        .background(Color("BackgroundColor"))
        .navigationTitle("Sipariş Geçmişi".localized)
                ...
                VStack(alignment: .trailing, spacing: 4) {
                    HStack(spacing: 4) {
                        Image(systemName: order.status.icon)
                            .font(.system(size: 10))
                        Text(order.status.rawValue.localized)
    ...
    private var emptyState: some View {
        VStack(spacing: 16) {
            ...
            Text("Sipariş geçmişi bulunamadı".localized)
                .font(.system(size: 16, weight: .semibold))
                .foregroundColor(Color("Text"))
            Text("Tamamlanan siparişleriniz burada görünecek.".localized)
                .font(.system(size: 13))
                .foregroundColor(.secondary)
            Spacer()
        }
...
struct FavoriteProvidersPage: View {
    ...
    var body: some View {
        ...
        .background(Color("BackgroundColor"))
        .navigationTitle("Favorilerim".localized)
        .navigationBarTitleDisplayMode(.inline)
    ...
    private var emptyState: some View {
        VStack(spacing: 16) {
            ...
            Image(systemName: "heart.slash")
                .font(.system(size: 52))
                .foregroundColor(Color("PrimaryColor").opacity(0.4))
            Text("Henüz favori yok".localized)
                .font(.system(size: 16, weight: .semibold))
                .foregroundColor(Color("Text"))
            Text("Beğendiğiniz uzmanları favorilere ekleyin.".localized)
                .font(.system(size: 13))
                .foregroundColor(.secondary)
            Spacer()
        }
