    ...
    private var profilePhotoSection: some View {
        VStack(spacing: 12) {
            ZStack(alignment: .bottomTrailing) {
                ...
                .overlay(
                    Circle()
                        .stroke(Color("PrimaryColor").opacity(0.2), lineWidth: 3)
                )
    ...
    private var personalInfoSection: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            VStack(spacing: 14) {
                // Ad & Soyad
                HStack(spacing: 12) {
                    customInputField(icon: "person.fill", placeholder: "Ad", text: $firstName)
                    customInputField(icon: "person.fill", placeholder: "Soyad", text: $lastName)
                }
            ...
            Button {
                ...
                HStack {
                    ...
                    VStack(alignment: .leading, spacing: 2) {
                        ...
                        Text("Hesap şifreni güvenli şekilde güncelle")
                            .font(.system(size: 12))
                            .foregroundColor(.secondary)
                    }
